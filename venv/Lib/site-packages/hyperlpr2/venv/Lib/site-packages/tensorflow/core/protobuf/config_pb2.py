...
_CONFIGPROTO_EXPERIMENTAL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='client_handles_error_formatting', full_name='tensorflow.ConfigProto.Experimental.client_handles_error_formatting', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='executor_type', full_name='tensorflow.ConfigProto.Experimental.executor_type', index=2,
